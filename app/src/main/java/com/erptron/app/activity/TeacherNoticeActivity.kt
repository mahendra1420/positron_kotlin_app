...
import com.positron.teachers.databinding.ActivityTeacherNoticeBinding
...
class TeacherNoticeActivity : BaseActivity(), View.OnClickListener, NoticeBoardAdapter.BookingDetailsAdapterInterface {

    private lateinit var binding: ActivityTeacherNoticeBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityTeacherNoticeBinding.inflate(layoutInflater)
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    ...
                    if (noticeDataList.isEmpty()) {
                        ...
                        noticeBoardAdapter =
                            NoticeBoardAdapter(this@TeacherNoticeActivity, noticeDataList, this@TeacherNoticeActivity)
    ...
    /*private fun getNoticeBoardDataFromDate(month: String, year: String) {
        ...
        call.enqueue(object : Callback<NoticeBoardWeb<List<NoticeData>>> {
            override fun onResponse(
                ...
                if (response.isSuccessful) {
                    noticeDataList.clear()
                    noticeDataList = response.body()?.notice_board_web as MutableList<NoticeData>
                    if (noticeDataList.isEmpty()) {
                        binding.rvNoticeBoard.visibility = View.GONE
                        binding.noDataLayout.visibility = View.VISIBLE
                    } else {
    ...
    override fun onDocumentClick(item: NoticeData?) {
        if (item!!.content_type.equals("document")) {
            val url = "https://docs.google.com/gview?embedded=true&url=${item.attachment_url}"
